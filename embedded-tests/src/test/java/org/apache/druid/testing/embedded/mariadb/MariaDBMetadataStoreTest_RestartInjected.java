...
/**
 * Same as {@link IndexTaskTest_RestartInjected}, but using a MariaDB metadata store instead of Derby.
 */
public class MariaDBMetadataStoreTest_RestartInjected extends IndexTaskTest_RestartInjected
{
  @Override
