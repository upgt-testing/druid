 ...
 */
public class EmbeddedMSQRealtimeQueryTest_RestartInjected extends BaseRealtimeQueryTest
{
  ...
  public void test_selectCount_task_default()
  {
    ...
    RestartFramework.at("after_selectCount_task_default_run")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
    ...
    RestartFramework.at("after_selectCount_task_default_assertion")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_selectCount_task_withRealtime()
  {
    ...
    final MSQTaskReportPayload payload = msqApis.runTaskSqlAndGetReport(sql);
    RestartFramework.at("after_selectCount_task_withRealtime_run")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_selectCount_task_withRealtime_assertion")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_selectCount_dart_default()
  {
    ...
    RestartFramework.at("after_selectCount_dart_default_run")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_selectCount_dart_default_assertion")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_selectCount_dart_noRealtime()
  {
    ...
    final long selectedCount = Long.parseLong(msqApis.runDartSql(sql));
    RestartFramework.at("after_selectCount_dart_noRealtime_run")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_selectCount_dart_noRealtime_assertion")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_selectBroadcastJoin_dart()
  {
    ...
    RestartFramework.at("after_selectBroadcastJoin_dart_assertion")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_selectBroadcastJoin_task_withRealtime()
  {
    ...
    RestartFramework.at("after_selectBroadcastJoin_task_submit")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_selectBroadcastJoin_task_assertion")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_selectSortMergeJoin_task_withRealtime()
  {
    ...
    final MSQTaskReportPayload payload = msqApis.runTaskSqlAndGetReport(sql);
    RestartFramework.at("after_selectSortMergeJoin_task_run")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_selectSortMergeJoin_task_assertion")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_selectSortMergeJoin_dart()
  {
    ...
    RestartFramework.at("after_selectSortMergeJoin_dart_run")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_selectSortMergeJoin_dart_assertion")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_selectJoinwithLookup_task_withRealtime()
  {
    ...
    final MSQTaskReportPayload payload = msqApis.runTaskSqlAndGetReport(sql);
    RestartFramework.at("after_selectJoinwithLookup_task_run")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_selectJoinwithLookup_task_assertion")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_selectJoinwithLookup_dart()
  {
    ...
    RestartFramework.at("after_selectJoinwithLookup_dart_run")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_selectJoinwithLookup_dart_assertion")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_selectJoinWithConcatVirtualDimension_task_withRealtime()
  {
    ...
    final MSQTaskReportPayload payload = msqApis.runTaskSqlAndGetReport(sql);
    RestartFramework.at("after_selectJoinWithConcatVirtualDimension_task_run")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_selectJoinWithConcatVirtualDimension_task_assertion")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_selectJoinWithConcatVirtualDimension_dart()
  {
    ...
    RestartFramework.at("after_selectJoinWithConcatVirtualDimension_dart_run")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_selectJoinWithConcatVirtualDimension_dart_assertion")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_scanWithFilter_task_withRealtime()
  {
    ...
    final MSQTaskReportPayload payload = msqApis.runTaskSqlAndGetReport(sql);
    RestartFramework.at("after_scanWithFilter_task_run")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_scanWithFilter_task_assertion")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_scanWithFilter_dart()
  {
    ...
    final String result = msqApis.runDartSql(sql);
    RestartFramework.at("after_scanWithFilter_dart_run")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_scanWithFilter_dart_assertion")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_groupByWithFilter_task_withRealtime()
  {
    ...
    final MSQTaskReportPayload payload = msqApis.runTaskSqlAndGetReport(sql);
    RestartFramework.at("after_groupByWithFilter_task_run")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_groupByWithFilter_task_assertion")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_groupByWithFilter_dart()
  {
    ...
    final String result = msqApis.runDartSql(sql);
    RestartFramework.at("after_groupByWithFilter_dart_run")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_groupByWithFilter_dart_assertion")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_scanWithFilterAfterJoin_task_withRealtime()
  {
    ...
    final MSQTaskReportPayload payload = msqApis.runTaskSqlAndGetReport(sql);
    RestartFramework.at("after_scanWithFilterAfterJoin_task_run")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_scanWithFilterAfterJoin_task_assertion")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_scanWithFilterAfterJoin_dart()
  {
    ...
    final String result = msqApis.runDartSql(sql);
    RestartFramework.at("after_scanWithFilterAfterJoin_dart_run")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_scanWithFilterAfterJoin_dart_assertion")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
