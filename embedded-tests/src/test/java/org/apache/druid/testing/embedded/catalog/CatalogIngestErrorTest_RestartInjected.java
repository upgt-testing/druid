 ...
 */
public class CatalogIngestErrorTest_RestartInjected extends CatalogTestBase
{
  ...
  public void testInsertNoPartitonedByFromCatalogOrQuery()
  {
    ...
    RestartFramework.at("after_table_created_no_partition")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
    ...
    RestartFramework.at("after_partition_error_verified")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testInsertNonDefinedColumnIntoSealedCatalogTable()
  {
    ...
    client.createTable(table, true);
    RestartFramework.at("after_sealed_table_created")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_undefined_column_error_verified")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testInsertWithIncompatibleTypeAssignment()
  {
    ...
    client.createTable(table, true);
    RestartFramework.at("after_type_table_created")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_incompatible_type_error_verified")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testInsertGroupByWithIncompatibleTypeAssignment()
  {
    ...
    client.createTable(table, true);
    RestartFramework.at("after_complex_type_table_created")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_complex_type_error_verified")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
