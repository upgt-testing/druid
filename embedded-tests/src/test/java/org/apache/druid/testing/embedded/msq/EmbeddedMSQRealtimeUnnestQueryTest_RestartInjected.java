...
public class EmbeddedMSQRealtimeUnnestQueryTest_RestartInjected extends BaseRealtimeQueryTest
{
  ...
  public void test_unnest_task_withRealtime()
  {
    ...
    RestartFramework.at("after_unnest_realtime_task_run")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
    ...
    RestartFramework.at("after_unnest_realtime_assertion")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_unnest_dart()
  {
    ...
    RestartFramework.at("after_dart_sql_run")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_dart_assertion")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
