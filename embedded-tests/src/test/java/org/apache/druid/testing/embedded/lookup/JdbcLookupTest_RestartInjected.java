 ...
 */
public class JdbcLookupTest_RestartInjected extends EmbeddedClusterTestBase
{
  ...
  public void test_derbyJdbcLookup() throws Exception
  {
    ...
    RestartFramework.at("after_lookup_table_populated")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
    ...
    RestartFramework.at("after_lookups_initialized")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_lookup_created")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    broker.start();
    RestartFramework.at("after_broker_started")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_lookup_query_verified")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
