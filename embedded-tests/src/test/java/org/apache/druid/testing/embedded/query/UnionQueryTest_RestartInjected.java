 ...
 * </ul>
 */
public class UnionQueryTest_RestartInjected extends EmbeddedClusterTestBase
{
  ...
  public void test_ingestData_andVerifyNativeAndSQLQueries()
  {
    ...
    RestartFramework.at("after_datasources_ingested")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
    ...
    RestartFramework.at("after_timeseries_query")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_search_query")
        .on(cluster)
        .restart("historical")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_topn_query")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_bitmap64_queries")
        .on(cluster)
        .restart("historical")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_union_all_sql_queries")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
