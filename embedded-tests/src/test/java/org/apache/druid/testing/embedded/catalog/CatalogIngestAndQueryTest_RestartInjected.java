 ...
 */
public abstract class CatalogIngestAndQueryTest_RestartInjected extends CatalogTestBase
{
  private final String dmlPrefixPattern;

  public CatalogIngestAndQueryTest_RestartInjected()
  {
  ...
  public void testInsertImplicitCast()
  {
    ...
    RestartFramework.at("after_task_succeed")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
