 ...
 * embedded server.
 */
public class CustomNodeRoleDockerTest_RestartInjected extends EmbeddedClusterTestBase implements LatestImageDockerTest
{
  ...
  {
    RestartFramework.at("before_node_discovery_verification")
        .on(cluster)
        .restart("router")
        .withIndex(0)
    ...
    RestartFramework.at("after_node_discovery_verification")
        .on(cluster)
        .restart("router")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
