...
public class CoordinatorPauseTest_RestartInjected extends EmbeddedClusterTestBase
{
  ...
  public void test_segmentsAreNotLoaded_ifCoordinatorIsPaused() throws Exception
  {
    ...
    RestartFramework.at("after_coordinator_pause")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
    ...
    RestartFramework.at("after_ingestion_task")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_duty_status_check")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_unavailable_segments_verify")
        .on(cluster)
        .restart("historical")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_coordinator_unpause")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
