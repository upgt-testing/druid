 ...
 */
public class HttpEmitterEventCollectorTest_RestartInjected extends EmbeddedClusterTestBase
{
  ...
  public void test_runIndexTask_andQueryData()
  {
    ...
    RestartFramework.at("after_task_complete_metric")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_schema_cache_refresh")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
