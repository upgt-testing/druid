 ...
 */
public class EmbeddedDurableShuffleStorageTest_RestartInjected extends EmbeddedClusterTestBase
{
  ...
  public void test_selectFirstPage()
  {
    ...
    RestartFramework.at("before_select_first_page")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
    ...
    RestartFramework.at("after_select_first_page")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_selectCount()
  {
    ...
    RestartFramework.at("before_select_count")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    assertStageOutputIsDurable(payload, false);
    RestartFramework.at("after_select_count")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_selectJoin_broadcast()
  {
    ...
    RestartFramework.at("before_join_broadcast")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    assertStageOutputIsDurable(payload, false);
    RestartFramework.at("after_join_broadcast")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_selectJoin_sortMerge()
  {
    ...
    RestartFramework.at("before_join_sortmerge")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    assertStageOutputIsDurable(payload, false);
    RestartFramework.at("after_join_sortmerge")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_selectJoin_sortMerge_durableDestination()
  {
    ...
    RestartFramework.at("before_durable_destination")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_durable_destination_query")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
