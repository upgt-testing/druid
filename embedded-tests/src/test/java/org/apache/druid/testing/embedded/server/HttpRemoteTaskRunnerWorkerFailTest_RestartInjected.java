...
public class HttpRemoteTaskRunnerWorkerFailTest_RestartInjected extends EmbeddedClusterTestBase
{
  ...
  public void test_overlord_marksTaskAsFailed_ifIndexerCrashes() throws Exception
  {
    ...
    RestartFramework.at("after_task_started")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_task_discovered")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_task_failed")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
