...
/**
 * Same as {@link IndexTaskTest_RestartInjected}, but using a PostgreSQL metadata store instead of Derby.
 */
public class PostgreSQLMetadataStoreTest_RestartInjected extends IndexTaskTest_RestartInjected
{
  @Override
