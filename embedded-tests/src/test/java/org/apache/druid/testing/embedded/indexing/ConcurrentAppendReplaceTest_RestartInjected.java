...
public class ConcurrentAppendReplaceTest_RestartInjected extends EmbeddedClusterTestBase
{
  ...
  public void test_concurrentAppend_toIntervalWithUnusedSegment_usesNewSegmentId()
  {
    ...
    RestartFramework.at("after_first_task_submit")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
    ...
    RestartFramework.at("after_mark_segments_unused")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_second_task_submit")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
