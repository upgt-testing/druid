 ...
 * {@link OverlordClient}.
 */
public class OverlordClientTest_RestartInjected extends EmbeddedClusterTestBase
{
  ...
  public void test_findCurrentLeader()
  {
    ...
    RestartFramework.at("after_findCurrentLeader")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
  ...
  public void test_runTask_ofTypeNoop()
  {
    ...
    RestartFramework.at("after_runTask_ofTypeNoop")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_runKillTask()
  {
    ...
    cluster.callApi().waitForTaskToSucceed(taskId, overlord);
    RestartFramework.at("after_runKillTask")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_taskStatuses_forCompleteTasks()
  {
    ...
    RestartFramework.at("after_taskStatuses_forCompleteTasks")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_supervisorStatuses()
  {
    ...
    RestartFramework.at("after_supervisorStatuses")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_getWorkers()
  {
    ...
    RestartFramework.at("after_getWorkers")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_getTotalWorkerCapacity()
  {
    ...
    RestartFramework.at("after_getTotalWorkerCapacity")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_markSegmentsAsUnused_basic()
  {
    ...
    Assertions.assertNotNull(result);
    RestartFramework.at("after_markSegmentsAsUnused_basic")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
