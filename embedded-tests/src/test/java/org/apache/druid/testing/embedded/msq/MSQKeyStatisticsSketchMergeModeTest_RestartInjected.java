...
public class MSQKeyStatisticsSketchMergeModeTest_RestartInjected extends EmbeddedClusterTestBase
{
  ...
  public void testMsqIngestionParallelMerging()
  {
    ...
    RestartFramework.at("after_parallel_merge_task_submit")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
    ...
    RestartFramework.at("after_parallel_merge_task_complete")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_parallel_merge_query")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMsqIngestionSequentialMerging()
  {
    ...
    RestartFramework.at("after_sequential_merge_task_submit")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
        .execute();
    cluster.callApi().waitForTaskToSucceed(sqlTaskStatus.getTaskId(), overlord);
    RestartFramework.at("after_sequential_merge_task_complete")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_sequential_merge_query")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void testMsqIngestionSequentialMergingWithEmptyStatistics()
  {
    ...
    SqlTaskStatus sqlTaskStatus = msqApis.submitTaskSql(context, queryLocal);
    RestartFramework.at("after_empty_stats_task_submit")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
        .execute();
    cluster.callApi().waitForTaskToSucceed(sqlTaskStatus.getTaskId(), overlord);
    RestartFramework.at("after_empty_stats_task_complete")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_empty_stats_query")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
