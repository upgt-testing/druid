...
public class CompactionTaskTest_RestartInjected extends CompactionTestBase
{
  ...
  public void testCompactionWithQueryGranularityInGranularitySpec() throws Exception
  {
    try (final Closeable ignored = unloader(fullDatasourceName)) {
      ...
      RestartFramework.at("after_verification_1")
          .on(cluster)
          .restart("broker")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_compaction_task_1")
          .on(cluster)
          .restart("overlord")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_verification_2")
          .on(cluster)
          .restart("broker")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_compaction_task_2")
          .on(cluster)
          .restart("overlord")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      verifySegmentIntervals(expectedIntervalAfterCompaction);
      RestartFramework.at("after_verification_3")
          .on(cluster)
          .restart("broker")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
  ...
  public void testParallelHashedCompaction() throws Exception
  {
    try (final Closeable ignored = unloader(fullDatasourceName)) {
      ...
      RestartFramework.at("after_compaction_task")
          .on(cluster)
          .restart("overlord")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
