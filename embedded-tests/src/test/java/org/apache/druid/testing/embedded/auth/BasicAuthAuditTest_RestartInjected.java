 ...
 */
public class BasicAuthAuditTest_RestartInjected extends EmbeddedClusterTestBase
{
  ...
  public void test_createRole_createsSingleAuditEntry() throws Exception
  {
    ...
    RestartFramework.at("after_role_created")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
    ...
    RestartFramework.at("after_audit_verified")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
