 ...
 */
public class HighAvailabilityTest_RestartInjected extends EmbeddedClusterTestBase
{
  ...
  public void test_allNodesHaveDiscoveredEachOther()
  {
    ...
    RestartFramework.at("after_node_discovery")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
        .execute();
    RestartFramework.at("after_node_discovery_broker")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
  ...
  public void test_switchLeader_andVerifyUsingSysTables()
  {
    ...
    RestartFramework.at("after_segment_metadata_cache")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    for (int i = 0; i < 3; ++i) {
      ...
      RestartFramework.at("after_sys_tasks_query")
          .on(cluster)
          .restart("broker")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_sys_segments_query")
          .on(cluster)
          .restart("historical")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_sys_servers_query")
          .on(cluster)
          .restart("broker")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_overlord_leader_switch")
          .on(cluster)
          .restart("overlord")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
      ...
      RestartFramework.at("after_coordinator_leader_switch")
          .on(cluster)
          .restart("coordinator")
          .withIndex(0)
          .withMode(RestartMode.GRACEFUL)
