...
public class EmbeddedKafkaSupervisorTest_RestartInjected extends EmbeddedClusterTestBase
{
  ...
  public void test_runKafkaSupervisor() throws Exception
  {
    ...
    RestartFramework.at("after_kafka_records_produced")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
    ...
    RestartFramework.at("after_supervisor_submitted")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_broker_discovers_segments")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_supervisor_status_verified")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_task_status_verified")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_row_count_verified")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_supervisor_suspended")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_segments_handed_off")
        .on(cluster)
        .restart("indexer")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
