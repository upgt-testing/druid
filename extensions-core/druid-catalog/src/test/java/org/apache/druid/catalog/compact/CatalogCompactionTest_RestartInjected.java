...
public class CatalogCompactionTest_RestartInjected extends EmbeddedClusterTestBase
{
  ...
  @Test
  public void test_ingestDayGranularity_andCompactToMonthGranularity() throws Exception
  {
    // Ingest data at DAY granularity and verify
    runIngestionAtDayGranularity();
    RestartFramework.at("after_day_granularity_ingestion")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
    ...
    RestartFramework.at("after_day_segments_verified")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_catalog_table_created")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_catalog_metadata_verified")
        .on(cluster)
        .restart("broker")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_compaction_supervisor_enabled")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_compaction_supervisor_posted")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_compaction_task_completed")
        .on(cluster)
        .restart("overlord")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
    ...
    RestartFramework.at("after_month_segments_verified")
        .on(cluster)
        .restart("coordinator")
        .withIndex(0)
        .withMode(RestartMode.GRACEFUL)
